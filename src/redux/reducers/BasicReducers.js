...
export const prePostTaxChoice = (prePostTaxChoice = initialState.prePostTaxChoice, action) => {
	switch (action.type) {
...
export const basicResultsPreTax = (basicResultsPreTax = initialState.basicResultsPreTax, action) => {
	switch (action.type) {
...
export const basicResultsPostTax = (basicResultsPostTax = initialState.basicResultsPostTax, action) => {
	switch (action.type) {
